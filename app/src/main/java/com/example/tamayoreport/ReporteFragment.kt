...
class ReporteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtCoordinates = view.findViewById(R.id.txtLocation)
    ...
    private val resultLauncher =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(requireContext(), "Imagen tomada", Toast.LENGTH_SHORT).show()
                //imgPhoto.setImageBitmap(bitmap)
            } else {
                Toast.makeText(requireContext(), "Imagen no tomada", Toast.LENGTH_SHORT).show()
            }
        }
